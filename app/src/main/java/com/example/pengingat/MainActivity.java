...
public class MainActivity extends AppCompatActivity {
    ...
    private void insertDataToDb(String title, String date, String time) {
        boolean insertData = databaseHelp.insertData(title, date, time);
        if (insertData) {
            try {
                populateListView();
    ...
    private void populateListView() {
        try {
            ArrayList<ModelData> items = databaseHelp.getAllData();
    ...
    private void showAddDialog() {
        ...
        final View dialogView = inflater.inflate(R.layout.custom_dialog_paken, null);
        ...
        dialogBuilder.setTitle("Buat panasin kendaraan ");
        dialogBuilder.setPositiveButton("Tambah", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                if (title.length() != 0) {
                    ...
                    toastMsg("Mohon Maaf Ya , Gak boleh isinya kosong.");
                }
            }
        });
